...
function NavLogeado() {
	return (
		<ul className={`${styles.flex_horizontal} ${styles.margen_horizontal} ${styles.items_centro} ${styles.barrita_navegacion} ${styles.fondo_circular}`}>
			<li><Link href="/productos/computadoras">Computadoras</Link></li>
			<li><Link href="/productos/smartphones">Smartphones</Link></li>
			<li><Link href="/productos/accesorios">Accesorios</Link></li>
			<li><Link href="/productos/audio">Audio</Link></li>
			<li><Link href="/profile"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-user-round-icon lucide-user-round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/></svg></Link></li>
...
function NavSinLog() {
	return (
		<ul className={`${styles.flex_horizontal} ${styles.margen_horizontal} ${styles.items_centro} ${styles.barrita_navegacion} ${styles.fondo_circular}`}>
			<li><Link href="/productos">Computadoras</Link></li>
			<li><Link href="/productos">Smartphones</Link></li>
			<li><Link href="/productos">Accesorios</Link></li>
			<li><Link href="/productos">Audio</Link></li>
